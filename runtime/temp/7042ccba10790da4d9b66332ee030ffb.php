...
<div class="page-content">
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            ...
            <?php if(empty($cid) || (($cid instanceof \think\Collection || $cid instanceof \think\Paginator ) && $cid->isEmpty())): ?>
            <li class="active">文章管理列表</li>
            <?php else: ?>
            <li>
                <a href="<?php echo url('article/lst'); ?>">文章管理列表</a>
            </li>
            <li class="active"><?php echo htmlentities($type[$cid]); ?></li>
            <?php endif; ?>
        </ul>
    </div>
    <!-- /Page Breadcrumb -->
                            ...
                            <table class="table table-bordered table-hover">
                                        ...
                                        <th class="text-center" width="10%">
                                            <div class="input-group-btn">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="<?php echo url('article/lst',array('cid'=>$k)); ?>"><?php echo htmlentities($tp); ?></a></li>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"><?php echo htmlentities($vo['desc']); ?></td>
                                        <td align="left"><?php if($vo['thumb'] == ''): ?>暂无缩略图<?php else: ?><img src="<?php echo htmlentities($vo['thumb']); ?>" style="width:50px;"/><?php endif; ?></td>
                                        <td align="center"><?php echo htmlentities(date('Y-m-d H:i',!is_numeric($vo['time'])? strtotime($vo['time']) : $vo['time'])); ?></td>
                                        <td align="center"><?php echo htmlentities($type[$vo['type']]); ?></td>
                                        <td align="center"><?php if($vo['is_recommend'] == 1): ?>推荐<?php else: ?>不推荐<?php endif; ?></td>
                                        <td align="center">
