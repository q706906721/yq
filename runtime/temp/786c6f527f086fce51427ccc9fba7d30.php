...
<div class="page-content">
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo url('lst'); ?>">栏目列表</a></li>
                    ...
                    <div class="widget-body">
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data" id="uploadForm">
                                <input type="hidden" name="id" value="<?php echo htmlentities($banner['id']); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" name="img" value="<?php echo htmlentities($banner['img']); ?>">
                                        <?php if($banner['img'] != ''): ?><img src='<?php echo htmlentities($banner['img']); ?>' style='width:60%;' class='img'/><?php endif; ?>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" placeholder="请输入跳转地址" name="url" type="text" value="<?php echo htmlentities($banner['url']); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
