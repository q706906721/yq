...
//             var formData = new FormData($('#uploadForm')[0]);
//             $.ajax({
// url:"<?php echo url('article/ajUpload'); ?>",//请求的页面地址
